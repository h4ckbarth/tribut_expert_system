...
class CofinsEngine(KnowledgeEngine):
    ...
    def cofins_compra_cst(self, ncm):
        if ncm in ('19053100', '19059090', '21069029', '17049020'):
            self.declare(TributBaseFact(cofins_cst="50"))  #Operação com direito a crédito
        elif ncm in ('22030000', '08119000', '22021000', '22011000'):
        ...
        elif ncm in ('08043000', '02012010', '02012090', '10063021'):
